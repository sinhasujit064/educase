...
{/* awesome-features end */}
              ...
              <section className="testimonial-style-ten bg-white">
                <div className="container">
                    ...
                    <div className="col-xl-6 col-lg-12 col-md-12 content-column">
                      <div className="content-box">
                        ...
                        <div className="testimonial-carousel-2 owl-carousel owl-theme">
                          <div className="testimonial-content">
                            <div className="inner-box">
                              ...
                              <div className="author-info">
                                ...
                                <h4 className="name">
                                  Vaishali Vyas</h4>
                                <span className="designation">Head of IT, First Round Capital</span>
                              </div>
                            </div>
                          </div>
                          <div className="testimonial-content">
                          ...
                          <div className="testimonial-content">
                            <div className="inner-box">
                              <div className="text">“Even if you use Okta for deprovisioning, it can’t do everything you need to do. BetterCloud picks up where Okta leaves off.”</div>
                              <div className="author-info">
                                <ul className="rating clearfix">
                                  <li><i className="fas fa-star" /></li>
                                  <li><i className="fas fa-star" /></li>
                                ...
                                <h4 className="name">Ryan Donnon</h4>
                                <span className="designation">Head of IT, First Round Capital</span>
                              </div>
                            </div>
                          </div>
